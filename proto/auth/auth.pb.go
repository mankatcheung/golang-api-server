...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	".auth.User\x126\n" +
	"\x06Logout\x12\x15.auth.MessageResponse\x1a\x15.auth.MessageResponseB)Z'github.com/golang-api-server/proto/authb\x06proto3"
...
var file_proto_auth_auth_proto_goTypes = []any{
	...
	(*ProfileRequest)(nil),  // 3: auth.ProfileRequest
	(*AuthResponse)(nil),    // 4: auth.AuthResponse
	(*User)(nil),            // 5: auth.User
	(*MessageResponse)(nil), // 6: auth.MessageResponse
}
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	3, // 3: auth.AuthService.GetProfile:input_type -> auth.ProfileRequest
	6, // 4: auth.AuthService.Logout:input_type -> auth.MessageResponse
	4, // 5: auth.AuthService.Register:output_type -> auth.AuthResponse
	4, // 6: auth.AuthService.Login:output_type -> auth.AuthResponse
	4, // 7: auth.AuthService.RefreshToken:output_type -> auth.AuthResponse
	5, // 8: auth.AuthService.GetProfile:output_type -> auth.User
	6, // 9: auth.AuthService.Logout:output_type -> auth.MessageResponse
