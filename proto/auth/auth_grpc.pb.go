...
type AuthServiceClient interface {
	...
	Logout(ctx context.Context, in *MessageResponse, opts ...grpc.CallOption) (*MessageResponse, error)
}
...
func (c *authServiceClient) Logout(ctx context.Context, in *MessageResponse, opts ...grpc.CallOption) (*MessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	Logout(context.Context, *MessageResponse) (*MessageResponse, error)
...
func (UnimplementedAuthServiceServer) Logout(context.Context, *MessageResponse) (*MessageResponse, error) {
...
func _AuthService_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Logout(ctx, req.(*MessageResponse))
	}
	return interceptor(ctx, in, info, handler)
}
